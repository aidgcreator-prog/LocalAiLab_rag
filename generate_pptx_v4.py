...
def create_presentation(output_path):
    ...
    content.text = (
        ...
        "Computer Vision (CV):\n"
        "• Technology that enables computers to 'see' and interpret visual information\n"
    ...
    slide = prs.slides.add_slide(slide_layout)
    title = slide.shapes.title
    title.text = "Core Components: GenAI"
    content = slide.placeholders[1]
    content.text = (
        "Generative AI (GenAI):\n"
        "• A subset of AI focused on the creation of new, original content\n"
        "• Examples: Automated content creation, Graphic design, Personalized marketing"
    )
    ...
    content.text = (
        ...
        "• Understanding the relationship between data, algorithms, and core components is essential for innovation."
    )
...
if __name__ == "__main__":
    create_presentation("AI_Fundamentals_Presentation.pptx")
