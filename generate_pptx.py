...
def create_presentation(output_path):
    ...
    content = slide.placeholders[1]
    content.text = (
        "• AI has evolved from theoretical Turing concepts to transformative modern tools.\n"
        "• Key drivers: High-quality data, algorithms, and structured output.\n"
        "• Core technologies: ML, DL, NLP, CV, and GenAI.\n"
        "• Understanding these fundamentals is essential for leveraging AI for innovation and competitive advantage."
    )
